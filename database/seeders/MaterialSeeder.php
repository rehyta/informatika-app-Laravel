...
class MaterialSeeder extends Seeder
{
    ...
    public function run(): void
    {
        Material::create([
            ...
            'soal'=>'
                <p>
                    <b>Oke, mari kenalan dengan compiler kita</b>
                    ini adalah halaman compiler. halaman ini terdiri dari : <br>
                    1. instruksi <br>
                    2. area input <br>
                    3. area output <br>
                    4. tombol run <br>
                ...
                <p>
                    ...
                    <b>area output</b> ini adalah kotak yang akan menunjukkan output dari kodingan kita apabila sudah di running. <br>
                    <b>tombol run</b> adalah tombol yang digunakan untuk memproses codingan <br>
                    <b>tombol submit</b> adalah tombol yang berguna untuk menyimpan hasil codingan <br>
                </p>
                <p>
                    Jadi, alurnya adalah, kalian membaca <b>instruksi</b> dengan seksama, 
                    kemudian ketikkan kode kalian di <b>area input.</b> jika sudah, kalian 
                    tekan tombol <b>run</b> untuk menjalankan kodingan kalian. jika hasil 
                    sudah muncul di <b>area output</b>, tekan tombol <b>submit</b> untuk 
                    menyimpan prosesnya.
                </p>
                <p>mudah kan? bagaimana jika kalian coba dengan kode sederhana?
                    <pre>
                        #include < iostream >
                            using namespace std;
                    ...
                    coba ketikkan kode diatas di area input dan lihat apa outputnya :)
              </p>
            ',
                ...
                <div style="font-size: 16px">
                    ...
                    <p>
                        <ul class="list-group list-group-flush">
                            ...
                            <br><img src="/img/course 2-2.jpeg" width="500" height="300" alt="struktur dasar C++">
                            <br>
                            Jika tidak mau menggunakan <mark>std::</mark> terus menerus, maka gunakanlah <mark>std</mark> di <i>namespace</i></li>
                            <img src="/img/course 2-1.jpeg" width="500" height="300" alt="struktur dasar C++">
