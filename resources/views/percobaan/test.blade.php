<div class="compiler md-1">
  ...
  <div class="input-code">
      ...
      <form class="input md-1" method="post" action="{{ url('/compilersave') }}">
          @csrf
          <button type="submit" class="run-btn mb-1 bg-danger" name="run"><i class="bi bi-caret-left-fill" style="color: black"></i>RUN</button>
          <br>
